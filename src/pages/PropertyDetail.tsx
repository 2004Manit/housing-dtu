                ...
                >
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div className="flex-1">
                      ...
                      {property.roomPricing.singleSharing && property.roomPricing.singleSharing > 1 ? (
                      ...
                      ) : property.roomPricing.singleSharing === 1 ? (
                        <span className="text-base sm:text-xl font-semibold text-yellow-400">Contact Owner</span>
                      ) : (
                ...
                >
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div className="flex-1">
                      ...
                      {property.roomPricing.doubleSharing && property.roomPricing.doubleSharing > 1 ? (
                        <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                      ...
                      ) : property.roomPricing.doubleSharing === 1 ? (
                        <span className="text-base sm:text-xl font-semibold text-yellow-400">Contact Owner</span>
                      ) : (
                        <span className="text-base sm:text-xl font-semibold text-red-400">Not Available</span>
                      )}
                ...
                >
                  ...
                  <div className="pt-3 sm:pt-4 border-t border-border/50 space-y-2 sm:space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`text-xs sm:text-sm font-semibold capitalize ${property.status === 'available' ? 'text-green-400' :
              ...
              >
                ...
                >
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`text-sm font-semibold capitalize ${property.status === 'available' ? 'text-green-400' :
                        property.status === 'not-available' ? 'text-red-400' :
                          'text-yellow-400'
                      }`}>
                      {property.status === 'contact-owner' ? 'Contact Owner' : property.status.replace('-', ' ')}
