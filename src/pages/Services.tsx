...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 sm:pt-24 lg:pt-0 max-w-full">
        ...
        {/* Simplified Glowing Orbs - CSS animation instead of framer-motion */}
        <div className="absolute top-10 sm:top-20 -left-10 sm:left-10 w-40 h-40 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full bg-cyan-500/10 blur-3xl animate-pulse" />
        <div className="absolute bottom-10 sm:bottom-20 -right-10 sm:right-10 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 rounded-full bg-blue-500/10 blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                <div
                  className="inline-block px-4 sm:px-6 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/5 mb-6 hover:border-cyan-500/50 transition-colors"
                >
      ...
      <div className="pb-20 bg-[#0a0a0a]">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-12 sm:mb-16 md:mb-20 px-2 sm:px-0">
            {[
              {
                icon: Shield,
                title: "100% Verified",
              ...
              <div key={index} className="relative group h-full hover:-translate-y-1 transition-transform">
          ...
          <div className="space-y-16 sm:space-y-24">
            ...
            <section className="relative">
              <div className="lg:pl-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 px-2 sm:px-0">
                  {[
                    {
                      icon: Building2,
            ...
            <section className="relative">
              <div className="lg:pr-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6 px-2 sm:px-0">
                  {[
                    {
                      icon: UserCheck,
      ...
      <div className="relative py-16 sm:py-20 md:py-28 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block px-4 sm:px-6 py-2 rounded-full border border-cyan-500/30 bg-cyan-500/5 mb-6 hover:border-cyan-500/50 transition-colors">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-white leading-tight px-4">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 bg-gradient-to-r from-cyan-400 via-blue-500 to-cyan-400 bg-clip-text text-transparent">
                  Waiting
                </span>
                <div className="absolute -bottom-1 sm:-bottom-2 left-0 right-0 h-0.5 sm:h-1 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full" />
              </span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4 max-w-full">
              <a href="/Properties" className="w-full sm:w-auto group relative px-8 sm:px-10 py-4 rounded-lg overflow-hidden font-semibold text-sm sm:text-base md:text-lg hover:scale-105 transition-transform">
              ...
              <a href="/List-Property" className="w-full sm:w-auto group relative px-8 sm:px-10 py-4 rounded-lg border-2 border-cyan-500/50 font-semibold text-sm sm:text-base md:text-lg overflow-hidden hover:scale-105 transition-transform">
