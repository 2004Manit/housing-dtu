    ...
    >
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 py-16 sm:py-20 max-w-5xl relative z-10">
        ...
        >
          ...
          >
            Your flat listing has been submitted for review. Our admin team will verify the details and approve your listing shortly. You'll be notified once it's live!
          </motion.p>
        </motion.div>
            ...
            >
              ...
              <div className="border-b border-white/10 pb-4 sm:pb-5 md:pb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium text-sm sm:text-base">Flat</p>
                  </div>
                </div>
              </div>

              {/* Pricing - RESPONSIVE (Full Width) */}
              <div className="border-b border-white/10 pb-4 sm:pb-5 md:pb-6">
                <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                ...
                <div>
                  <div>
                    <p className="text-white/50 text-xs sm:text-sm mb-1">Monthly Rent</p>
                    <p className="text-white font-medium text-base sm:text-lg">₹{formData.rent}/month</p>
                  </div>
                </div>
              </div>
              ...
              <div className="border-b border-white/10 pb-4 sm:pb-5 md:pb-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                    <div>
                      <p className="text-white/50 text-xs sm:text-sm mb-1">BHK</p>
                      <p className="text-white font-medium text-sm sm:text-base">{formData.bhk} BHK</p>
                    </div>
                    <div>
                      <p className="text-white/50 text-xs sm:text-sm mb-1">Current Flatmates</p>
                      <p className="text-white font-medium text-sm sm:text-base">{formData.currentFlatmates}</p>
                    </div>
                    <div>
                      <p className="text-white/50 text-xs sm:text-sm mb-1">Flatmates Required</p>
                      <p className="text-white font-medium text-sm sm:text-base">{formData.flatmatesRequired}</p>
                    </div>
                    <div>
                      <p className="text-white/50 text-xs sm:text-sm mb-1">Brokerage</p>
                      <p className="text-white font-medium text-sm sm:text-base">
                        {formData.brokerage === 'zero-brokerage' ? 'Zero Brokerage' : 'Brokerage Applicable'}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Amenities - RESPONSIVE (Flat-specific only) */}
              {formData.selectedAmenities && formData.selectedAmenities.length > 0 && (
                <div className="border-b border-white/10 pb-4 sm:pb-5 md:pb-6">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <h3 className="text-lg sm:text-xl font-semibold text-white">Flat Amenities</h3>
                  </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 sm:gap-3">
                      {formData.images.slice(0, 6).map((image: File, index: number) => (
                        <div 
                          key={index}
...
export default FlatListingSuccess;