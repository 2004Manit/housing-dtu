...
const roomAmenities = [
  ...
  { id: 'balcony-some', label: 'Balcony (in rooms)', icon: Home, color: { bg: 'bg-green-500/10', text: 'text-green-400' } },
  { id: 'balcony-all', label: 'Common Balcony', icon: Home, color: { bg: 'bg-emerald-500/10', text: 'text-emerald-400' } },
];
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3">
                      {['one-time', 'monthly', 'NA'].map((option) => (
                        <motion.button
                          ...
                          className={`py-3 sm:py-4 px-2 sm:px-4 rounded-lg sm:rounded-xl font-medium text-xs sm:text-sm md:text-base transition-all ${formData.securityDeposit === option
                            ? 'bg-green-500 text-white shadow-lg shadow-green-500/50'
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                      {['included', 'not-included'].map((option) => (
                        <motion.button
                          ...
                          className={`py-3 sm:py-4 px-3 sm:px-4 rounded-lg sm:rounded-xl font-medium text-xs sm:text-sm md:text-base transition-all ${formData.mess === option
                            ? 'bg-green-500 text-white shadow-lg shadow-green-500/50'
                            : 'bg-white/5 text-white/70 hover:bg-white/10'
                            }`}
                        >
                    ...
                    return (
                      ...
                      >
                        <div className="flex flex-col items-center text-center gap-2 sm:gap-3">
                          <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl flex items-center justify-center ${isSelected ? facility.color.bg : 'bg-white/10'
                            }`}>
